...
import DailyAttemptsLineChart from "./DailyAttemptsLineChart";
import PassRateBarChart from "./PassRateBarChart";

const passRateData = [
  { subject: "Math", passRate: 86 },
  { subject: "Eng", passRate: 92 },
  { subject: "Chem", passRate: 81 },
  { subject: "Phy", passRate: 95 },
  { subject: "Gov", passRate: 74 },
  { subject: "Bio", passRate: 78 },
];

const dailyAttemptsData = [
  { date: "Mon", attempts: 20 },
  { date: "Tue", attempts: 32 },
  { date: "Wed", attempts: 15 },
  { date: "Thu", attempts: 40 },
  { date: "Fri", attempts: 28 },
  { date: "Mon", attempts: 20 },
];
