...
import { fetchStudentProfile } from "../studentdashboard/studentSlice.js";
  ...
  return (
    <section className="bg-white shadow rounded-xl p-6 border space-y-6">
      ...
      {ActiveUpdate && (
        ...
        <SignupForm style="overflow-hidden bg-white shadow-md pt-2 pb-8 lg:px-10 px-6 w-full bg-blue-500 m-auto rounded-lg" />
      )}
